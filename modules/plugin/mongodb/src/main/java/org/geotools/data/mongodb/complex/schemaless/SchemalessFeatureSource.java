...
public class SchemalessFeatureSource implements FeatureSource<FeatureType, Feature>  {
    ...
    public FeatureType getSchema() {
        ...
        ComplexFeatureTypeImpl complexFeatureType= new ComplexFeatureTypeImpl(name, Collections.emptyList(),descriptor,false,Collections.emptyList(),null,null);
    ...
    private GeometryDescriptor getGeometryDescriptorIfPresent(){
        ...
        if (geometries==null || geometries.isEmpty())
            ...
            geometryField = geometries.iterator().next();
    ...
    public SchemalessFeatureReader getReader(){
        return null;
    }
