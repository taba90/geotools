...
* ``operationAttribute``: the name of the attribute whose value will be used to perform the MIN or MAX operation.

* ``groupingAttributes``: a lists of attribute names defining the features' groups for which perform the filtering process.
